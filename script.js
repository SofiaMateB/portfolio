...
function efectoHabilidades(){
    ...
    if(distancia_skills >= 300){
        ...
        habilidades[6].classList.add("angul");
        habilidades[7].classList.add("trabajo");
        habilidades[8].classList.add("sql");
        habilidades[9].classList.add("pl_sql");
        habilidades[10].classList.add("mysql");
        habilidades[11].classList.add("posgres");
        ...
        habilidades[16].classList.add("tiempo");
        habilidades[17].classList.add("resp");
        habilidades[18].classList.add("org");
